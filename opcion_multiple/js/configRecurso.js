...
var calificarEnTiempoReal = true; //si se quiere el despliegue de correcto/incorrecto al seleccionar...
...
var retroCal = [ // RAAR may 28, 18 la coma al inicio del renglon solo es un truco par inhibir una linea sin preocuparte por la coma q esta arriba....
	{LimInf: 0, LimSup:8, Mensaje: ["Revisa nuevamente la unidad."]}
	,{LimInf: 9, LimSup: 12, Mensaje: ["Hay conceptos que necesitas precisar."]}
...
var idioma = "ENG"; // ESP-Español, ENG-INGLES
var debug = false;
if (debug) {
